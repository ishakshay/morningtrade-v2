...
var OptionsChainGrid = function() {
  ...
  var fetchGridData = function() {
    ...
    var promiseCE = fetch('https://api.morningtrade.in/api/options-chain-grid?symbol=' + symbol + '&interval=' + validInterval + '&data_type=' + dataType + '&option_type=CE&strike_range=' + strikeRange)
      .then(function(response) { return response.json(); });
    
    var promisePE = fetch('https://api.morningtrade.in/api/options-chain-grid?symbol=' + symbol + '&interval=' + validInterval + '&data_type=' + dataType + '&option_type=PE&strike_range=' + strikeRange)
      .then(function(response) { return response.json(); });
